...
exports.generateEstimateHtml = void 0;
const generateEstimateHtml = (estimate) => {
    const { AreaDetails = {}, squareFeetRange, totalPerSqftCost, minEstimate, maxEstimate, layoutType, selectedDesignOptions = [], createdBy = {}, } = estimate;
