...
router.post("/create", Uploads_1.uploadS3.single("image"), ValidateCokkies_1.checkAuth, (0, CheckDesignation_1.checkRole)(["Employee"]), Blogs_Controller_1.createBlogController);
...
router.put("/:blogId/update", Uploads_1.uploadS3.single("image"), ValidateCokkies_1.checkAuth, (0, CheckDesignation_1.checkRole)(["Employee"]), Blogs_Controller_1.updateBlogController);
