...
exports.CollaborationModel = void 0;
...
const CollaborationSchema = new mongoose_1.Schema({
    ...
    addedBy: { type: mongoose_1.Schema.Types.ObjectId, ref: "Employee", required: true },
    memberId: { type: mongoose_1.Schema.Types.ObjectId, ref: "Employee", required: true },
}, { timestamps: true });
