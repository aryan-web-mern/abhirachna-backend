...
router.post("/create", Uploads_1.uploadCloudinaryTestimonial.fields([
...
router.put("/:id/update", ValidateCokkies_1.checkAuth, (0, CheckDesignation_1.checkRole)(["Employee"]), Uploads_1.uploadCloudinaryTestimonial.fields([
    { name: "image", maxCount: 1 },
    { name: "video", maxCount: 1 },
