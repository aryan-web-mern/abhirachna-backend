...
exports.generateMeetingMailHtml = void 0;
const getDateAccZone_1 = require("../../utils/getDateAccZone");
const generateMeetingMailHtml = (msg, customerTimeZone) => {
    console.log(msg, 'msg in generateMeetingMailHtml');
    const { dateAndTime, phone, message, name, } = msg;
    return `
  <div style="font-family: sans-serif; max-width: 800px; margin: auto; padding: 20px; border: 1px solid #ddd;">
    ...
    <p><strong>Date and Time:</strong> ${(0, getDateAccZone_1.getDateAccZone)(dateAndTime, customerTimeZone) + " " + customerTimeZone?.toLocaleUpperCase() || ""}</p>
...
exports.generateMeetingMailHtml = generateMeetingMailHtml;
