...
const seedUserId = new ObjectId("665000000000000000000001");
const now = new Date();
...
const blogs = [
  {
    ...
    subheading:
      "A practical guide to creating homes that feel premium, personal, and easy to live in.",
    image:
  ...
  },
  {
    ...
    subheading:
      "Smart furniture, hidden storage, and zoning ideas for smaller homes.",
    image:
...
const testimonials = [
  {
    ...
    text:
      "Abhirachnaa understood our requirements clearly and transformed our living room into a warm, practical space. The team was professional from planning to execution.",
    image:
  ...
  },
  {
    ...
    text:
      "The modular kitchen design was exactly what we needed. It looks premium and makes everyday cooking much easier.",
    image:
  ...
  },
  {
    ...
    text:
      "They helped us make a compact apartment feel spacious and organized. The storage planning made a huge difference.",
    image:
...
const jobs = [
  {
    ...
    summary:
      "Join our design team to create functional and beautiful residential interiors for modern Indian homes.",
    department: "Design",
    createdBy: seedUserId,
  ...
  },
  {
    ...
    summary:
      "We are looking for a responsible site supervisor to manage execution quality and timelines.",
...
async function upsertMany(collection: any, records: any[]) {
